//
//  WNDWeatherCurrentConditionPhrasesDefine.h
//
//  Created by unchi on 2014/06/11.
//  Copyright (c) 2014年 unchi. All rights reserved.
//


NSString* const WNDWeatherCurrentConditionPhrases[] = {
    @"^(Light |Heavy )?Drizzle$",
    @"^(Light |Heavy )?Rain$",
    @"^(Light |Heavy )?Snow$",
...
WNDWeatherCurrentConditionPhraseSummary const WNDWeatherCurrentConditionPhraseSummaryIndexs[] = {
    WNDWeatherCurrentConditionPhraseSummaryRain,
    WNDWeatherCurrentConditionPhraseSummaryRain,
    WNDWeatherCurrentConditionPhraseSummarySnow,
    WNDWeatherCurrentConditionPhraseSummarySnow,
    WNDWeatherCurrentConditionPhraseSummarySnow,
    WNDWeatherCurrentConditionPhraseSummarySnow,
    WNDWeatherCurrentConditionPhraseSummarySnow,
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummarySmoke,
    WNDWeatherCurrentConditionPhraseSummaryVolcanicAsh,
    WNDWeatherCurrentConditionPhraseSummarySmoke,
    WNDWeatherCurrentConditionPhraseSummarySand,
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummarySand,
    WNDWeatherCurrentConditionPhraseSummarySand,
    ...
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummaryFog,
    WNDWeatherCurrentConditionPhraseSummaryCloud,
    WNDWeatherCurrentConditionPhraseSummaryClear,
    WNDWeatherCurrentConditionPhraseSummaryCloud,
    WNDWeatherCurrentConditionPhraseSummaryCloud,
    WNDWeatherCurrentConditionPhraseSummaryRain,
    WNDWeatherCurrentConditionPhraseSummarySnow,
    WNDWeatherCurrentConditionPhraseSummaryRain,
    WNDWeatherCurrentConditionPhraseSummaryFunnelCloud,
    WNDWeatherCurrentConditionPhraseSummaryUnknown,
    WNDWeatherCurrentConditionPhraseSummaryUnknown,
};
